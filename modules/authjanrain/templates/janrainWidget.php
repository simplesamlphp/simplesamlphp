...
<script src="<?php echo(SimpleSAML_Module::getModuleURL('authjanrain/resources/scripts/janrain-init.js')); ?>"></script>
...
<input type="hidden" id="samlCaptureServerUrl" name="captureServerUrl" value="Capture Server URL" />
<input type="hidden" id="samlCaptureToken" name="captureToken" value="ACCESS_TOKEN" />
<?php
